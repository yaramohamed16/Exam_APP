...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) => ExamsCubit()..getExamPackages()..getHomeAds(),
      child: BlocConsumer <ExamsCubit , ExamsStats>(
        ...
        builder: (BuildContext context, Object? state) {
          return Scaffold(
            ...
            body:
            ExamsCubit.get(context).examPackagesData != null ?
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        TextButton(
                            onPressed: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context) =>const ExamPackageList(),));
                            },
                            child: Text(
                              'View all',
                              style: TextStyle(
